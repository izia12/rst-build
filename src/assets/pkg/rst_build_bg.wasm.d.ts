...
export const get_table_data: (a: number, b: number, c: number, d: number) => [number, number, number, number];
...
export const get_table_data_for_frontend: (a: number, b: number, c: number, d: number) => [number, number];
