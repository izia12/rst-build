...
export function create_docx_legacy(sli_data: string, txt_data: string, xlsx_data: Uint8Array): Promise<Uint8Array>;
...
export function get_processed_data_for_frontend(): string;
export function create_docx_for_single_floor(floor_level: string, floor_data_json: string, combinations_json: string): Promise<Uint8Array>;
...
export interface InitOutput {
  ...
  readonly create_docx_legacy: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
  ...
  readonly get_processed_data_for_frontend: () => [number, number];
  readonly create_docx_for_single_floor: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
  ...
  readonly closure268_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1076_externref_shim: (a: number, b: number, c: any, d: any) => void;
