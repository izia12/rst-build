 ...
 * @returns {Uint8Array}
 */
export function create_custom_sortament_report(available_diameters, floors_data_json) {
    const ptr0 = passArray32ToWasm0(available_diameters, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(floors_data_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.create_custom_sortament_report(ptr0, len0, ptr1, len1);
    if (ret[3]) {
 ...
 * @param {string} str
 */
export function str_log_data(str) {
 ...
 */
export function initialize_gpu_renderer() {
    const ret = wasm.initialize_gpu_renderer();
    return ret;
}
 ...
 * @returns {string}
 */
export function convert_sli_xsl_to_json_string() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.convert_sli_xsl_to_json_string();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function convert_data_to_js_order_byz() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.convert_data_to_js_order_byz();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {Promise<Uint8Array>}
 */
export function create_docx_legacy(sli_data, txt_data, xlsx_data) {
    const ptr0 = passStringToWasm0(sli_data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(txt_data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(xlsx_data, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.create_docx_legacy(ptr0, len0, ptr1, len1, ptr2, len2);
    return ret;
}
 ...
 * @returns {Uint8Array}
 */
export function get_changed_row_data(planes) {
    const ret = wasm.get_changed_row_data(planes);
 ...
 * @returns {Uint8Array}
 */
export function get_custom_sortament_report(available_diameters, floors_data_json) {
    const ptr0 = passArray32ToWasm0(available_diameters, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(floors_data_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.get_custom_sortament_report(ptr0, len0, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {string}
 */
export function get_table_data_for_frontend(available_diameters, floors_data_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray32ToWasm0(available_diameters, wasm.__wbindgen_malloc);
        ...
        const ptr1 = passStringToWasm0(floors_data_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.get_table_data_for_frontend(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {Promise<Uint8Array>}
 */
export function create_docx_for_selected_combinations(selected_floors_json) {
    const ptr0 = passStringToWasm0(selected_floors_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.create_docx_for_selected_combinations(ptr0, len0);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rst_build_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
